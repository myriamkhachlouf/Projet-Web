...
<head>
	...
	formControl.className = 'slim-control error';
	small.innerText = message;
}

    function setSuccessFor(input) {
	const formControl = input.parentElement;
	formControl.className = 'slim-control success';
}
        }
    </script>
    <script>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-3">
                            <ul class="menu-extra">
                                ...
                                <li><a href="login-register.php"><span class=""></span></a></li>
        ...
        <!-- Start Login Register Area -->
                ...
                <!-- Start Single Content -->
                            <div id="register" role="tabpanel" >
                                <form class="login" action="ajoutvendeur.php" method="post" onsubmit="return validation()">
                                    ...
                                    <input id="marque" name="marque" type="text" placeholder="Marque*" required >
                                    <input id="produit" name="produit" type="Produit" placeholder="Produit*" required >
                                    <input id="telephone" name="telephone" type="tel" placeholder="Telephone*"pattern="[0-9]{8}" required>
                                    <input id="email" name="email" type="email" placeholder="Email*"pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
                                    <input id="quantite" name="quantite" type="number" placeholder="quantite*" max="5000" required >
                                        <input type="submit"  value="Proposer Mon Produit">
