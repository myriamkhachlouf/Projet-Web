                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="htc__login__register__wrap">
                                ...
                                <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                                    <form class="login" action="clientlog.php" method="post" >
                                ...
                                <div id="register" role="tabpanel" class="single__tabs__panel tab-pane fade">
                                    <form class="login" action="ajoutclient.php" onsubmit="return validateForm()" method="post"name="myForm">
                                        ...
                                        <input id="telephone" name="telephone" type="text" placeholder="Telephone*"pattern="[0-9]{8}" required>
                                        <input id="email" name="email" type="email" placeholder="Email*"pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
                                        <input id="password" name="password" type="password" placeholder="Password*"  pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$">
                                        <div class="g-recaptcha" data-sitekey="6LeGtO4UAAAAAAIqKOSuDDirYXjht7ivWzgOOxSJ"></div>
